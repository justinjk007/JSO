...
\usepackage{xcolor}
\usepackage{soul}
\definecolor{foreground}{RGB}{184, 83, 83}
\definecolor{background}{RGB}{255, 231, 231}
\let\OldTexttt\texttt
\renewcommand{\texttt}[1]{\OldTexttt{\colorbox{background}{\textcolor{foreground}{#1}}}}
